...
var i = qual.value;
document.location=('conservacao.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('conservacao.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from estado_conserv";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from estado_conserv as a order by estado_conserv asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Estado
              de conservação </div></td>
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['estado_conserv'] ?>">
          <td colspan="2" align="justify"><? echo $row['descricao'] ?></td>
          <td align="center" width='12%'><? echo "<a href=\"conservacao1.php?op=del&conserva=".base64_encode($row['estado_conserv'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[estado_conserv]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[estado_conserv]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"conservacao1.php?op=update&conserva=".base64_encode($row['estado_conserv'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[estado_conserv]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"conservacao1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"conservacao.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"conservacao.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"conservacao.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"conservacao.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total cadastrado: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
