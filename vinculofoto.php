...
var i = qual.value;
document.location=('vinculofoto.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('vinculofoto.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from vinculo_foto";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from vinculo_foto as a order by nome asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Nome
              do v&iacute;nculo</div></td>
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['vinculo_foto'] ?>">
          <td colspan="2" align="justify"><? echo $row[nome] ?></td>
          <td align="center" width='12%'><? echo "<a href=\"vinculofoto1.php?op=del&vinculofoto=".base64_encode($row['vinculo_foto'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[vinculo_foto]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[vinculo_foto]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"vinculofoto1.php?op=update&vinculofoto=".base64_encode($row['vinculo_foto'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[vinculo_foto]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"vinculofoto1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"vinculofoto.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"vinculofoto.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"vinculofoto.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"vinculofoto.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de vínculos cadastrados: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="vinculofoto" type="hidden" id="vinculofoto" value="<? echo $vinculofoto ?>">
