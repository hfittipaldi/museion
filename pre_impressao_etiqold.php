...
<tr><td>  
<font ><b><?echo $lista_autoria;?><br></b></font>
<font><?echo $nascimentotxt;?></font><br><br>
<font><b><?echo $row[titulo_etiq];?></b>
<?
...
fwrite($fh,"</td>");
?>
<?echo $parteass_ing;?><br>
<?echo $aquisicao_ing;?></font><br><br>
<?
 ...
 if  (($alt>0)and($larg>0)and($prof>0)) $ret=1;
     ...
     $sql_seq="SELECT fotografia from fotografia_obra where (obra = '$obra_id')";   
             $dbseq->query($sql_seq);
             $row_seq=$dbseq->dados();
