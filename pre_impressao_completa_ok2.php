     ...
     <td height="10" colspan="2">
      ...
      <? 
			...
			/*		$dt_aq_di= $row['dt_aquisicao_di']."-";
					...
					echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><br>Ex-proprietários: <b><br>";
?>					<textarea name='ex_proprietarios' id="ex_proprietarios" class="combo_cadastro rolagem" readonly style=" border:1px solid #ABABAB;" cols='75' rows='10'><? echo $ex_proprietarios; ?></textarea></b><br>
<?
					...
					echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><br>Observações: <b><br>";
?>					<textarea name='obs' id="obs" class="texto" readonly style=" border:1px solid #ABABAB;" cols='75' rows='10'><? echo $obs; ?></textarea></b><br>
<?
					...
					while ($par=$db2->dados()) {
						...
						echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><em><b> AUTORIA <br></b></em>" . $lista_autoria . "</font><hr>";
