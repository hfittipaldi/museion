...
<?
        //
        // Mudada a forma de devolver os dados. Se for feito através do onClick no botão Confirma chamando o script seleciona()
        // da 3a. vez trava o form. SOmente no IE6. No FireFox funciona. (PBL - EXD2190908 referente a PRD10)
        //
        if($_REQUEST[submit]<>'')
             {

		     echo "<script>opener.window.document.getElementById('autor').value=".$_REQUEST['selautor']."</script>";
