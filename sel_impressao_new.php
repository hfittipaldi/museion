...
function inicia_modelo() {     
   ...
   document.getElementById("tridimencional").checked= false;         
...
function muda_modelo($val) {
   ...
   if ($val=='1')
     ...
     { 
        ...
        if (document.getElementById("tridimencional").checked==true)
         { 
   	     document.getElementById("tridimencional").value= true;
         }else{
    	     document.getElementById("tridimencional").value= false;
           }
...
<body onLoad="inicia_modelo(<? echo $_REQUEST['modelo']; ?>)">
   ...
   <table width="100%"  height="100%" border="0"  style="border-bottom: 1px solid #34689A;border-top: 1px solid #34689A;border-left: 1px solid #34689A;border-right: 1px solid #34689A;">  
           ...
           <input type=hidden id=dtridimencional name=dtridimencional value="true">
               ...
               <tr><td width="2%">&nbsp;</td>
                ...
                <tr><td width="2%">&nbsp;</td>
                   <td width="43%" >
                      <div align="left">
                         <span class="texto_bold">
                            <input type="checkbox" name="tridimencional" id="tridimencional" value="false" onClick="muda_modelo(1); this.focus();">somente com imagem de obra tridimencional
                          </span>
                       </div>
                     </td>
                  </tr>          
