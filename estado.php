...
document.location=('estado.php?page='+ i);
}}


function posiciona(valor) {
var i = valor;
document.location=('estado.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  /////////////////////
	  $sql2="SELECT a.* from estado as a order by nome asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td width="65%" height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Estados</div></td>
          <td width="12%" bgcolor="#ddddd5" class="texto_bold"><div align="center">UF</div></td>
	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['estado'] ?>">
          <td align="justify" width='65%'><? echo $row[nome] ?></td>
          <td width='12%'><div align="center"><? echo $row[uf] ?>
            </div></td>
          <td align="center" width='12%'><? echo "<a href=\"estado1.php?op=del&est=".base64_encode($row['estado'])."\"
	...
	onMouseOut='document.getElementById(\"cor_fundo".$row[estado]."\").style.backgroundColor=\"\";'>";?>
          ...
          <td align="center" width='12%'><? echo "<a href=\"estado1.php?op=update&est=".base64_encode($row['estado'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[estado]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"estado1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"estado.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"estado.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"estado.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"estado.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de Estados cadastrados: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
