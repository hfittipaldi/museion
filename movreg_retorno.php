...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" onSubmit='return valida()' action="movimentacao2.php">
<table width="100%"  border="0" cellpadding="0" cellspacing="4">
        <tr>
          <td colspan="2" class="texto"><div align="center"><em>Informe o(s) parâmetro(s) de pesquisa:<br><br></em></div></td>
        </tr>
        <tr class="texto_bold">
