  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql2="SELECT a.* from restauro as a where (a.titulo='$_REQUEST[titulo]' or a.titulo like '%$_REQUEST[titulo]%') AND
	   a.tipo='$_REQUEST[tipo]' order by a.tombo + 0, a.tombo, a.seq_restauro, a.titulo LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td width="55%" height="24" bgcolor="#96ADBE" class="texto_bold"><div align="left"> &nbsp;&nbsp;Ocorr&ecirc;ncias
              encontradas para:
            <?  echo "<font color='FFFFFF'>&nbsp;".ucfirst($_REQUEST[titulo])."</font>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>            
            <div align="left"></div>            <div align="center"></div>            <div align="center"></div></td>
          <td width="45%" bgcolor="#96ADBE" class="texto_bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registro
	  ...
	  ?>
        <tr class="texto">
          <td colspan="3" align="justify"><b><? echo $row[titulo]; ?></b>            <div align="left">
