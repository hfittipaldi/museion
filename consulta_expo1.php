...
<table width="100%"  border="0" cellpadding="0" cellspacing="4">
        <tr class="texto">
          ...
          <td colspan="2" id="arealegado"><? if($row[tipo]=='C') { echo "<b>"."Coletiva"."</b>"; }
		     elseif($row[tipo]=='I') { echo "<b>"."Individual"."</b>"; }
		   ?></td>
          <td width="1%" align="right" valign="top">&nbsp;</td>
        </tr>
        <tr class="texto">
          <td valign="top"><div align="right">Data ref.:</div></td>
          <td colspan="2" id="arealegado"><? echo "<b>"."de " . formata_data($row[dt_inicial]) . " a " . formata_data($row[dt_final])."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto">
          <td valign="top"><div align="right">Nome:</div></td>
          <td colspan="2" id="arealegado"><? echo "<b>".str_replace('"',chr(ord('"')),$row[nome])."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto">
          <td valign="top"><div align="right">Institui&ccedil;&atilde;o: </div></td>
          <td colspan="2" id="arealegado"><? echo "<b>".$row[instituicao]."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto">
          <td valign="top"><div align="right">Pa&iacute;s:</div></td>
          <td colspan="2" id="arealegado"><? 
        ...
        <tr class="texto">
          ...
          <td colspan="2" id="arealegado"><? echo "<b>".$row[cidade]."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto">
	 ...
	 ?></td>
        ...
        <tr class="texto">
          ...
          <td colspan="2" id="arealegado"><? echo "<b>".$row[periodo]."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto">
          <td valign="top"><div align="right">Observa&ccedil;&atilde;o: </div></td>
          <td colspan="2" id="arealegado"><? echo "<b>".$row[premio]."</b>"; ?></td>
          <td valign="top" align="right">&nbsp;</td>
        </tr>
        <tr class="texto_bold">
          <td valign="top">&nbsp;</td>
        ...
        <tr class="texto_bold">
          <td valign="top"><br>
		  <? 
		   echo "<a href=\"exposicao_autor.php?op_autor=view&lista=1&".$parametro."=".$valor."\"'><img src='imgs/icons/btn_voltar.gif' border='0' alt='Voltar'>";
		  ?></td>
		  <? if ($row[txt_legado]<>'') { ?>
