...
var i = qual.value;
document.location=('PrincipalCompara_imagem.php?id=<? echo 70 ?>&op=<? echo 1 ?>&page='+ i);
	...
	//  $sql="SELECT count(*) from fotografia_obra as a, fotografia as b where a.fotografia = b.fotografia AND a.obra = '$_REQUEST[obra]'";
	 ...
	 // $sql2="SELECT a.*,b.titulo as tit,b.fotografia as foto from fotografia_obra as a, fotografia as b where a.fotografia = b.fotografia
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="4" align="right"><input class="combo_cadastro" style="width: 160px;" type="button" name="antes_depois" value="Visualizar Antes/Depois" onClick="abrepop('comparacao_imagem.php?restauro=<? echo $_REQUEST['id'] ?>');"></td>
		</tr>
        <tr bgcolor="#96ADBE">
...
/*					$ext=$img['ext'];
        ...
        <tr class="texto">
          ...
          <td><br>
            <? if ($imagem<>'' && $noimage=='') { ?>
            <a style="display:none;" id="img_pop_imagem" href="javascript:;" onClick="abrepop('comparacao_imagem.php?imagem=<? echo $url[0]."/".$imagem; ?>&altura=<? echo $altu; ?>&largura=<? echo $larg; ?>&diametro=<? echo $diam; ?>', <? echo $height; ?>, <? echo $width; ?>);"><img src='imgs/icons/visualiza.gif' alt='Visualizar' border='0'></a></td>
		  <? } ?>
          <td align="left" valign="middle">
            <? if ($_REQUEST[op] <> 'view') {
				 echo "<a href=\"PrincipalCompara_imagem.php?op=del&rest=$img[restauro_fotografia]&id=".$_REQUEST[id]."\"
...
if($mais>$numpages)
   $mais=$numpages;
$a="<a href=\"PrincipalCompara_imagem.php?id=$_REQUEST[id]&page=".$first."&op=".$_REQUEST[op]."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"PrincipalCompara_imagem.php?id=$_REQUEST[id]&page=".$menos."&op=".$_REQUEST[op]."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"PrincipalCompara_imagem.php?id=$_REQUEST[id]&page=".$mais."&op=".$_REQUEST[op]."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"PrincipalCompara_imagem.php?id=$_REQUEST[id]&page=".$last."&op=".$_REQUEST[op]."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
