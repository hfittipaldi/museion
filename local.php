...
var i = qual.value;
document.location=('local.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('local.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	 ...
	 // $sql="SELECT count(*) as total from bibliografia where autor='33'";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from local as a order by nome asc LIMIT $registroinicial,$pagesize";
	  //$sql2="SELECT a.* from bibliografia as a where a.autor='33' order by a.bibliografia asc LIMIT $registroinicial,$pagesize ";
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td width="57%" height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left"> &nbsp; Local</div></td>
          <td width="19%" bgcolor="#ddddd5" class="texto_bold"><div align="center">Mov.
              controlada
              ? </div></td>
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['local'] ?>">
          ...
          <td align="center" width='12%'><? echo "<a href=\"local1.php?op=del&local=".base64_encode($row['local'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[local]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[local]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"local1.php?op=update&local=".base64_encode($row['local'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[local]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"local1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"local.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"local.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"local.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"local.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de locais cadastrados: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="local" type="hidden" id="local" value="<? echo $local ?>">
