	  ...
	  ?>
        ...
        <tr class="texto" id="cor_fundo<? echo $row['obrarel'] ?>">
         ...
         <td><?echo $row['titulo'];?></td>
          ...
          <td align="center"><? echo "<a href=\"relacionamento_obra1.php?op=del&obra=".$row[obra]."&obrarel=".$row[obrarel]."&relacionamento=".$row[relacionamento]."\"
...
<? }?>
        ...
        <tr class="texto">
          <td colspan="5">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"relacionamento_obra1.php?op=insert&obra=$obra\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo autor' >"?></td>
        </tr>
        <tr>
