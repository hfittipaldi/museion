  ...
  <tr>
    ...
    <td valign="top"><form name="form1" method="post" action="">
	 ...
	 $count=0;
	  ...
	  /////////////////////
	  $sql2="SELECT a.* from restauro as a where a.ir like '$_REQUEST[ir]' and a.tipo='$_REQUEST[tipo]' order by a.interna,a.ir + 0, a.tombo, a.seq_restauro, a.titulo";
	  $db->query($sql2);
	  ////////////////////
	   ?>
        ...
        <tr class="texto">
          ...
          <td width="7%" align="right">
             <? 
               if ($pagina=='restauracao_moldura_externa.php' or $pagina=='restauracao_moldura_interna.php')
               {
                  ...
                  echo "<a href=\"$pagina?op=update&op_restauro=update&id=".$row[restauro]."&form=restauro&tipo2=$tipo2&form2=alterar&filtro=".$row[ir]."&chama=ir"."\"><img src='imgs/icons/ic_alterar.gif' width='20' height='20'border='0' alt='Alterar restauração'></a>";           
               }else{
          ...
          <?if($row[tipo]=='4'){?>
              <td width="10%" align="center"><? echo $mold_registro?></td>
                   <td align="center" width='7%'><div align="center"><? echo "<a href=\"cadastro_moldura.php?tipo=4&ir=$row[ir]&op=update&tipo2=$tipo2&chama=moldura&form=restauro_altera_ir&obra=".$row[obra]."&parte=".$row[parte]."&moldura=".$row[moldura]."&tombo=".$_REQUEST[numregistro]."&num_registro=".$mold_registro."\">
