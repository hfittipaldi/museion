...
//////////////////////////////////////////////////////////////////
		...
		if ($tipo == 'obra')
                                    echo "<script>location.href='exposicao_obra_alterar.php?op=update&obrid=".$valor."&id=".$expid."';</script>";
                            elseif ($tipo == 'autor')
                                     echo "<script>location.href='exposicao_obra_alterar.php?op=update&autid=".$valor."&id=".$expid."';</script>";
		        else    
		          echo "<script>location.href='exposicao_listar.php?".$parametro."=".$valor."';</script>";
...
<body>
	  ...
	  ?>
        <tr >
           <td class="texto" width="7%" valign="top">  

            <?if ( substr($row['dt_inicial'],0,4) == '0000') {  echo "<b>s/d</b>";}else{echo "<b>".substr($row['dt_inicial'],0,4)."</b>";}?>            
          
           </td>

        <td class="texto" width="70%" valign="top">
	 <?echo "-<b>".$row['nome'].", "."</b>".$row['instituicao'].", ".$row['cidade'].", ";
          ...
          <td  width="10% align="center"><? echo "<a href=\"exposicao_listar_alterar.php?op=add&".$parametro."=".$valor."&id=".$row['exposicao']."\">
