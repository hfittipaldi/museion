...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
  <tr>
    <td width="600" valign="top"><form name="form1" method="post" onSubmit='return valida();' >
<?
...
<select name="estado" class="combo_cadastro" id="estado" >
  ...
  <? } ?>
		...
		<? } ?>
        <tr class="texto_bold">
         <? if ($op == 'update') {?><td valign="top"><br><? echo "<a href=\"exposicao_lista.php?nome=".$_REQUEST[nome]."&".$parametro."=".$valor."\"'><img src='imgs/icons/btn_voltar.gif' border='0' alt='Voltar'>"; ?></td><?}?>
         <? if ($op == 'insert')   {?><td valign="top"><br><? echo "<a href=\"exposicao_insere2.php?nome=".$_REQUEST[nome]."&".$parametro."=".$valor."\"'><img src='imgs/icons/btn_voltar.gif' border='0' alt='Voltar'>"; ?></td><?}?>
		  <? if ($row[txt_legado]<>'') { ?>
