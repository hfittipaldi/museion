...
<table width="100%" valign="top">
  <tr width="100%" valign="top">
    <td>            <table width="100%" valign="top" height="25%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#f2f2f2"> 
              <tr width="34%">
                 <?if ($_REQUEST[confirma]==false)
                   {?> 	         <td width="15%" align="left" style="border-bottom: 1px solid #34689A;border-top: 1px solid #34689A;border-left: 1px solid #34689A;">                                                  		
                    <input name="confirmar" type="submit" class="combo_cadastro" style="cursor:pointer; border-width: 1px;" id="confirmar" value="Confirmar" onClick="abrepop2('pre_impressao_etiq.php?form_ativo=&ultpag=1&txtpesquisa_rel=<?echo $txtpesquisa_rel;?>&modelo=<?echo $modeloR;?>&totpag=<?echo $_SESSION[paginas];?>&info_filtro=<?echo $info_filtro;?>&total=<?echo $total;?>&rodape=<?echo $rodape;?>&modelo2=false&comimagem=<?echo $comimagem;?>&traducao=<?echo $traducao;?>&tridimencional=<?echo $tridimencional;?>&tfa=<?echo $tfa;?>&tf=<?echo $tf;?>&distancia=2&de=<?echo $de;?>&ate=<?echo $ate;?>');"></td>
                 </td>
                  <?}?>
                 <?if ($_REQUEST[confirma]==true)
                   {?>
                    <td width="60%" align="left" style="border-bottom: 1px solid #34689A;border-top: 1px solid #34689A;">
	            ...
	            <td width="15%" align="left" style="border-bottom: 1px solid #34689A;border-top: 1px solid #34689A;">
                        <input name="salvar" type="submit"  class="combo_cadastro" style="cursor:pointer; border-width: 1px;" id="salvar" value="Salvar/Imprimir"onClick="abrepop3('pre_impressao_obras.php?form_ativo=download&ultpag=1&txtpesquisa_rel=<?echo $txtpesquisa_rel;?>&modelo=<?echo $modeloR;?>&totpag=<?echo $_SESSION[paginas];?>&info_filtro=<?echo $info_filtro;?>&total=<?echo $total;?>&rodape=<?echo $rodape;?>&modelo2=false&comimagem=<?echo $comimagem;?>&traducao=<?echo $traducao;?>&tridimencional=<?echo $tridimencional;?>&tfa=<?echo $tfa;?>&tf=<?echo $tf;?>&distancia=2');download();">
                    </td>

                 <?}?>
                 <td width="10%" align="right" style="border-bottom: 1px solid #34689A;border-top: 1px solid #34689A;">
                   <input name="fechar" type="submit"  class="combo_cadastro" style="cursor:pointer; border-width: 1px;" id="fechar" value="Fechar"onClick="window.close();">
                 </td>
...
if ($imgexiste ==1){
  ...
  if (($modelo6=='true') or ($modelo7=='true')){?>
