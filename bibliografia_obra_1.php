	...
	onMouseOut='document.getElementById(\"cor_fundo".$row[bibliografia]."\").style.backgroundColor=\"\";'>";?>
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[bibliografia]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td>&nbsp;</td>
          <td align="center"><? echo "<a href=\"bibliografia_insere2.php?op=insert&obrid=$obrid\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Adicionar referência' >"?></td>
        </tr>
        <tr>
