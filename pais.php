...
var i = qual.value;
document.location=('pais.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('pais.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
$_SESSION['lnk']=$link; 
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  /////////////////////
	  $sql2="SELECT a.* from pais as a order by nome asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td width="64%" height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Pa&iacute;s</div></td>
	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['pais'] ?>">
          <td align="justify" width='64%'><? echo $row[nome] ?></td>
          <td width='12%'><div align="center"><? echo $row[sigla] ?>
            </div></td>
          <td align="center" width='12%'><? echo "<a href=\"pais1.php?op=del&pais=".$row['pais']."\"
	...
	onMouseOut='document.getElementById(\"cor_fundo".$row[pais]."\").style.backgroundColor=\"\";'>";?>
          ...
          <td align="center" width='12%'><? echo "<a href=\"pais1.php?op=update&pais=".$row['pais']."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[pais]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"pais1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"pais.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"pais.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"pais.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"pais.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
$g= " Total de paises cadastrados: $numlinhas - Página: $page_atual de $numpages $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="est" type="hidden" id="est" value="<? echo $pais ?>">
