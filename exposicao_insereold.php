...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
  <tr>
    <td width="100%" valign="top"><form name="form1" method="post" onSubmit='return valida();' >
<?
...
//////////////////////////////////////////////////////////////////
	...
	echo "<script>location.href='exposicao_autor.php?".$parametro."=".$valor."';</script>";
   }
 }
...
if($_REQUEST['enviar']<>'') {
  ...
  if($op == 'update') {
	...
	if ($tipo == 'obra') {
           $sql2="Select count(*) as total from obra_exposicao where obra='$obrid' and exposicao='$id'";
           $db->query($sql2);
           $tot=$db->dados();
           if ($tot[total]==0)
           { 
	      $sql2= "INSERT into ".$tipo."_exposicao($tipo ,exposicao,premio) values('$valor','$id','$_REQUEST[premio]')";
	      $db->query($sql2);
           }else{
	...
	if ($tipo == 'autor') {
          $sql2="Select count(*) as total from autor_exposicao where autor='$obrid' and exposicao='$id'";
           $db->query($sql2);
           $tot=$db->dados();
           if ($tot[total]==0)
           { 
...
//////////////////////////////////////////////////////////////////
	 ...
	 echo "<script>location.href='exposicao_insere2.php?".$parametro."=".$valor."';</script>";
	 }
}
...
?>
        <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
             ...
             <tr width="100%">
                <td colspan="6 class="texto_bold">&nbsp;</td>
             </tr>
             <tr bgcolor="#96ADBE">
             ...
             <tr bgcolor="#96ADBE">
                ...
                <td height="24" bgcolor="#96ADBE" class="texto_bold" style="color: white;"><div align="left">&nbsp;&nbsp;Detalhes da exposição a vincular</div></td>

                <td valign="top"><? echo "<a href=\"exposicao_insere2.php?nome=".$_REQUEST[nome]."&".$parametro."=".$valor."\"'><img src='imgs/icons/btn_voltar.gif' border='0' alt='Voltar'>"; ?></td>
             </tr>
             <tr>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="6">
        ...
        <tr class="texto_bold">
          <? if ($id <> '') { ?>
			...
			<b>Nº da Exposição: </b><? echo $id."<br>&nbsp;";  ?></div>
		  </td>
           <?}?>
		  <td width="10%">&nbsp;</td>
		  <td width="10%">&nbsp;</td>
   ...
   <tr class="texto_bold">
      <td width="8%"><div align="right">Tipo:</div></td>
      <td width="8%">
          <select name="tipo" class="combo_cadastro"><option value=''></option>
            <option value="C" <? if($row[tipo]=='C') echo "Selected" ?>>Coletiva</option>
            <option value="I" <? if($row[tipo]=='I') echo "Selected" ?>>Individual</option>
          </select>
      </td>
      <td width="40%" nowrap>Data início
         <input name="dt_inicial" type="text" class="combo_cadastro" id="dt_inicial" value="<? echo formata_data($row[dt_inicial]) ?>" size="8" maxlength="10">
	      Data fim
         <input name="dt_final" type="text" class="combo_cadastro" id="dt_final" value="<? echo formata_data($row[dt_final]) ?>" size="8" maxlength="10">
      </td>
   </tr>
