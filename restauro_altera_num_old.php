...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td height="24" bgcolor="#96ADBE" class="texto_bold"><div align="left"> &nbsp;&nbsp;Ocorr&ecirc;ncias
              encontradas para o registro:<?  echo "<font color='FFFFFF'>&nbsp;".ucfirst($_REQUEST[num])."</font>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N&ordm; registro
               - Restaura&ccedil;&atilde;o</div>            
	  ...
	  ?>
        <tr class="texto">
          <td colspan="2" align="justify"><? echo $row[titulo] ?>            <div align="left">
            </div></td>
