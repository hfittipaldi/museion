  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
       ...
       <? 
          ...
          $sqlcis="SELECT count(*) as total FROM exposicao as a  INNER JOIN  movimentacao_exposicao as b on (a.exposicao=b.exposicao) where movimentacao='$movid' and tipo='C'";     
          $dbcis->query($sqlcis);
          $totcoletivas=$dbcis->dados();
          $totcoletivas=$totcoletivas[0];  
     

          $sqlcis="SELECT count(*) as total FROM exposicao as a  INNER JOIN  movimentacao_exposicao as b on (a.exposicao=b.exposicao) where movimentacao='$movid' and tipo='I'";     
          $dbcis->query($sqlcis);
          $totindividuais=$dbcis->dados();
          $totindividuais=$totindividuais[0];       


          $sqlcis="SELECT count(*) as total FROM exposicao as a  INNER JOIN  movimentacao_exposicao as b on (a.exposicao=b.exposicao) where movimentacao='$movid' and tipo=''";     
          $dbcis->query($sqlcis);
          $totsemdefinicao=$dbcis->dados();
          $totsemdefinicao=$totsemdefinicao[0];       

          $numlinhas=0;
          if ($tipo == 'movimentacao')   $sql="SELECT count(*) as total FROM exposicao as a  INNER JOIN  ".$tipo."_exposicao as b on (a.exposicao=b.exposicao)where ".$tipo."=".$valor;
	  ...
	  $numlinhas=$db->dados();
          ...
          $sql4="SELECT DISTINCT substring(dt_inicial,1,4) as datainicial, a.tipo as intext, a.exposicao, b.movimentacao_exposicao
      ...
      <?
          $comando="<a href=\"exposicao_movimentacao.php?movid=$movid&lista=1\"; onClick=''>";
          echo $comando;
      ?>
         <img src='imgs/icons/btn_listar.gif'  border='0' alt='Listar'></a>
          </td>
          <td width="7%" align="center" style=";">&nbsp;&nbsp;</td>
          <td width="7%" align="center" style=""><? $ref="exposicao_insere2.php?lista=".$lista."&op=insert&".$parametro."=".$valor;?>
...
if ($lista=='1'){ 
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
         ////////////////Lista as exposições referenta a movimentacao por ano /////////////////////////////////////////////
         /////////////////////////////////////////////////////////////////////////////////////////////////////////	 
	  ...
	  $sql2="SELECT a.exposicao as expid,a.nome,a.instituicao,a.periodo,a.cidade,a.estado,a.pais,a.tipo 
                    FROM exposicao as a INNER JOIN  movimentacao_exposicao as b on (a.exposicao=b.exposicao) where a.exposicao=".$row4[exposicao]." and b.movimentacao='$valor' order by a.tipo, a.dt_inicial, a.nome";
	  ...
	  <?
	     ...
	     <?echo "<b>- ".$row['nome'].", "."</b>".$row['instituicao'].", ".$row['cidade'].", ";
           ...
           <td width="5%" align="center"><? echo "<a href=\"exposicao_insere.php?lista=".$lista."&tipo=".$tipo."&op=del&".$parametro."=".$valor."&id=".$row4[movimentacao_exposicao]."\"
             ...
             <td width="5%" align="center"><? echo "<a href=\"exposicao_movimentacao_editar.php?lista=".$lista."&op=update&".$parametro."=".$valor."&id=".$row['expid']."\">
