...
var i = qual.value;
document.location=('movimentacao1.php?page='+ i+ '&registro=<? echo $_REQUEST[registro]; ?>&sde=<? echo $_REQUEST[sde]; ?>&sate=<? echo $_REQUEST[sate]; ?>&rde=<? echo $_REQUEST[rde]; ?>&rate=<? echo $_REQUEST[rate]; ?>');
}}
</script>
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['movimentacao'] ?>">
          ...
          <td width="7%" align="center" ><? echo "<a href=\"movimentacao.php?op=del&movid=".$row['movimentacao']."\"
	...
	onMouseOut='document.getElementById(\"cor_fundo".$row[movimentacao]."\").style.backgroundColor=\"\";'>";?>
          ...
          <td width="8%" align="center" ><? echo "<a href=\"movimentacao.php?op=update&movid=".$row['movimentacao']."&registro=".$_REQUEST[registro]."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[movimentacao]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="4">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"movpre_insere.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
?>               
    ...
    &nbsp;<? echo "<a href='movpre_altera.php'><img src='imgs/icons/btn_voltar.gif' width='20' height='20' border='0' alt='Voltar'></a>"?></td>
  </tr>
</table>
</body>
</html>
