...
$strConfigureTableCoord = 'Configureer de coÃ¶rdinaten voor de tabel %s';
...
$strFieldsTerminatedBy = 'Velden beÃ«indigd door';
...
$strHome = 'Home';
$strHomepageOfficial = 'OfficiÃ«le phpMyAdmin Website';
$strHost = 'Host';
...
$strIndexWarningMultiple = 'Meer dan 1 %s sleutel was gecreÃ«erd voor de kolom `%s`';
...
$strLinesTerminatedBy = 'Regels beÃ«indigd door';
...
$strPrivDescIndex = 'Maakt het mogelijk om indexen te creÃ«ren en te verwijderen.';
...
$strRecords = 'Records';
$strReferentialIntegrity = 'Controleer referentiÃ«le integriteit';
$strRefresh = 'Vernieuw';
