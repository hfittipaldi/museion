...
$month = array('Sij', 'Vel', 'OÅ¾u', 'Tra', 'Svi', 'Lip', 'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro');
...
$strAction = 'Akcija';
$strAddDeleteColumn = 'Dodaj/izbriÅ¡i stupac';
$strAddDeleteRow = 'Dodaj/izbriÅ¡i polje za kriterij';
$strAddNewField = 'Dodaj novi stupac';
$strAddSearchConditions = 'Dodaj uvjete pretraÅ¾ivanja (dio "where" upita):';
...
$strAfterInsertNewInsert = 'Dodaj joÅ¡ jedan red';
$strAll = 'Sve';
...
$strAtBeginningOfTable = 'Na poÄetku tablice';
...
$strBookmarkQuery = 'OznaÄeni SQL-upit';
$strBookmarkThis = 'OznaÄi SQL-upit';
...
$strCookiesRequired = '<i>Cookies</i> moraju biti omoguÄ‡eni.';
...
$strDoYouReally = 'Da li stvarno Å¾elite ';
$strDrop = 'IzbriÅ¡i';
...
$strLinesTerminatedBy = 'Linije zavrÅ¡avaju na';
$strLinksTo = 'Links to';
...
$strMySQLShowStatus = 'PrikaÅ¾i MySQL runtime informacije';
$strMySQLShowVars = 'PrikaÅ¾i MySQL sistemske varijable';

$strName = 'Ime';
$strNext = 'SljedeÄ‡i';
$strNo = 'Ne';
$strNoDatabases = 'Baza ne postoji';
$strNoDropDatabases = '"DROP DATABASE" naredba je onemoguÄ‡ena.';
$strNoFrames = 'phpMyAdmin preferira preglednike koji podrÅ¾avaju frame-ove.';
$strNoIndex = 'KljuÄ nije definiran!';
$strNoIndexPartsDefined = 'Dijelovi kljuÄa nisu definirani!';
$strNoModification = 'Nema nikakvih promjena';
$strNone = 'NiÅ¡ta';
$strNoPassword = 'Nema lozinke';
$strNoPrivileges = 'Nema privilegija';
$strNoRights = 'Nemate dovoljno prava za ovo podruÄje!';
$strNoTablesFound = 'Tablica nije pronaÄ‘ena u bazi.';
$strNotNumber = 'To nije broj!';
$strNoUsersFound = 'Korisnik(ci) nije pronaÄ‘en.';
$strNull = 'Null';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> dio mora biti namjeÅ¡ten u konfiguracijskoj datoteci (config.inc.php)!';
$strPos1 = 'PoÄetak';
$strPrevious = 'Prethodna';
$strPrimary = 'Primarni';
$strPrimaryKeyHasBeenDropped = 'Primarni kljuÄ je izbrisan';
$strPrimaryKeyName = 'Ime primarnog kljuÄa mora biti... PRIMARY!';
$strPrimaryKeyWarning = '("PRIMARY" <b>mora</b> biti ime i <b>samo</b> ime primarnog kljuÄa!)';
$strPrintView = 'SaÅ¾etak';
...
$strRowLength = 'DuÅ¾ina retka';
$strRows = 'Redaka';
$strRowsFrom = ' redaka poÄevÅ¡i od retka';
$strRowSize = ' VeliÄina retka ';
$strRowsModeHorizontal = 'horizontalnom';
$strRowsModeOptions = 'u %s naÄinu i ispiÅ¡i zaglavlje poslije svakog %s retka';
$strRowsModeVertical = 'vertikalnom';
$strRowsStatistic = 'Statistika redaka';
$strRunning = 'pokrenuto na %s';
$strRunQuery = 'IzvrÅ¡i SQL upit';
$strRunSQLQuery = 'IzvrÅ¡i SQL upit(e) na bazi ';

$strSave = 'Spremi';
$strSelectADb = 'Izaberite bazu';
$strSelectAll = 'OznaÄi sve';
...
$strSetEnumVal = 'Ako je polje "enum" ili "set", unesite vrijednosti u formatu: \'a\',\'b\',\'c\'...<br />Ako vam zatreba <i>backslash</i> ("\") ili jednostruki navodnik ("\'") navedite ih koristeÄ‡i <i>backslash</i> (npr. \'\\\\xyz\' ili \'a\\\'b\').';
$strShow = 'PrikaÅ¾i';
$strShowAll = 'PrikaÅ¾i sve';
$strShowingRecords = 'Prikaz redaka';
$strShowPHPInfo = 'PrikaÅ¾i informacije o PHP-u';
$strShowTables = 'PrikaÅ¾i tablice';
$strShowThisQuery = ' PrikaÅ¾i ovaj upit ponovo ';
...
$strSubmit = 'Pokreni';
$strSuccess = 'VaÅ¡ SQL upit je uspjeÅ¡no izvrÅ¡en';
$strSum = 'Ukupno';
...
$strTableHasBeenEmptied = 'Tablica %s je ispraÅ¾njena';
$strTableHasBeenFlushed = 'Tablica %s je osvjeÅ¾ena';
$strTableMaintenance = 'Radnje na tablici';
$strTables = '%s tablica/e';
$strTableStructure = 'Struktura tablice';
$strTableType = 'Vrsta tablice';
$strTextAreaLength = ' Zbog veliÄine ovog polja,<br /> polje moÅ¾da neÄ‡ete moÄ‡i mijenjati ';
$strTotal = 'ukupno';
$strType = 'Vrsta';
...
$strValue = 'Vrijednost';
$strViewDump = 'PrikaÅ¾i dump (shemu) tablice';
$strViewDumpDB = 'PrikaÅ¾i dump (shemu) baze';

$strWelcome = 'DobrodoÅ¡li u %s';
