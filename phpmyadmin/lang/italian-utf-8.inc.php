...
$strAllowInterrupt = 'Permette di interrompere il processo di importazione nel caso lo script rilevi che Ã¨ troppo vicino al tempo limite. Questo potrebbe essere un buon modo di importare grandi file, tuttavia potrebbe interrompere la transazione.';
...
$strAnd = 'E';
$strAndThen = 'e quindi';
$strAnIndex = 'Un indice Ã¨ stato aggiunto in %s';
$strAnyHost = 'Qualsiasi host';
$strAny = 'Qualsiasi';
$strAnyUser = 'Qualsiasi utente';
$strApproximateCount = 'PuÃ² essere approssimato. Vedere FAQ 3.11';
$strAPrimaryKey = 'Una chiave primaria Ã¨ stata aggiunta in %s';
$strArabic = 'Arabo';
$strArmenian = 'Armeno';
...
$strBookmarkDeleted = 'Il bookmark Ã¨ stato cancellato.';
...
$strBrowse = 'Mostra';
$strBufferPoolActivity = 'AttivitÃ  del Buffer Pool';
...
$strBzError = 'phpMyAdmin non Ã¨ capace di comprimere il dump a causa dell\'estensione Bz2 errata in questa versione di PHP. Vi raccomandiamo vivamente di settare il parametro <code>$cfg[\'BZipDump\']</code> nel vostro file di configurazione di phpMyAdmin a <code>FALSE</code>. Se volete utilizzare le capacitÃ  di compressione Bz2, dovreste aggiornare il PHP all\'ultima versione. Date un\'occhiata al bug report %s per uteriori dettagli.';
...
$strCompressionWillBeDetected = 'Il tipo di compressione del file importato sarÃ  automaticamente rilevato da: %s';
$strConfigFileError = 'phpMyAdmin non riesce a leggere il file di configurazione!<br />Questo puÃ² accadere se il php trova un parse error in esso oppure il php non trova il file.<br />Richiamate il file di configurazione direttamente utilizzando il link sotto e leggete il/i messaggio/i di errore del php che ricevete. Nella maggior parte dei casi ci sono un apostrofo o una virgoletta mancanti.<br />Se ricevete una pagina bianca, allora Ã¨ tutto a posto.';
...
$strCopy = 'Copia';
$strCopyDatabaseOK = 'Il Database %s Ã¨ stato copiato in %s';
$strCopyTable = 'Copia la tabella nel (database<b>.</b>tabella):';
$strCopyTableOK = 'La tabella %s Ã¨ stata copiata su %s.';
$strCopyTableSameNames = 'Impossibile copiare la tabella su se stessa!';
$strCouldNotKill = 'phpMyAdmin non Ã¨ in grado di terminare il thread %s. Probabilmente Ã¨ giÃ  stato terminato.';
$strCreate = 'Crea';
...
$strDatabaseEmpty = 'Il nome del DataBase Ã¨ vuoto!';
$strDatabaseExportOptions = 'Opzioni di esportazione del database';
$strDatabaseHasBeenDropped = 'Il Database %s Ã¨ stato eliminato.';
...
$strDefaultEngine = '%s Ã¨ il motore di memorizzazione predefinito su questo server MySQL.';
...
$strDeleteAndFlushDescr = 'Questa Ã¨ la vita piÃ¹ giusta, ma il caricamento dei privilegi puÃ² durare qualche secondo.';
$strDelete = 'Cancella';
$strDeleted = 'La riga Ã¨ stata cancellata';
...
$strDelOld = 'La Pagina corrente contiene Riferimenti a Tabelle che non esistono piÃ¹. Volete cancellare questi Riferimenti?';
...
$strDumpSaved = 'Il dump Ã¨ stato salvato sul file %s.';
...
$strEnclosingOptional = 'L\'inclusione dei campi Ã¨ opzionale';
$strEndCut = 'FINE CUT';
$strEnd = 'Fine';
$strEndRaw = 'FINE RAW';
$strEngineAvailable = '%s Ã¨ disponibile su questo server MySQL.';
$strEngineDisabled = '%s Ã¨ stato disabilitato su questo server MySQL.';
$strEngines = 'Motori';
...
$strField = 'Campo';
$strFieldHasBeenDropped = 'Il campo %s Ã¨ stato eliminato';
$strFields = 'Campi';
$strFieldsEmpty = ' Il contatore dei campi Ã¨ vuoto! ';
$strFieldsEnclosedBy = 'Campo composto da';
$strFieldsEscapedBy = 'Campo impedito da';
$strFieldsTerminatedBy = 'Campo terminato da';
$strFileAlreadyExists = 'Il file %s esiste giÃ  sul server: prego, cambiare nome del file o selezionare l\'opzione "sovrascrivi".';
$strFileCouldNotBeRead = 'Il filenon puÃ² essere letto';
$strFileNameTemplateHelp = 'Usare __DB__ per i nomi dei database, __TABLE__ per i nomi delle tabelle e %sany strftime%s opzione per le specifiche temporali, le estensioni saranno automaticamente aggiunte . Tutto il resto del testo verrÃ  preservato.';
$strFileNameTemplate = 'Nome file template';
$strFileNameTemplateRemember = 'ricorda il template';
$strFileToImport = 'File importato';
$strFixed = 'fisso';
$strFlushPrivilegesNote = 'N.B.: phpMyAdmin legge i privilegi degli utenti direttamente nella tabella dei privilegi di MySQL. Il contenuto di questa tabella puÃ² differire dai privilegi usati dal server se sono stati fatti cambiamenti manuali. In questo caso, Si dovrebbero %srinfrescare i privilegi%s prima di continuare.';
...
$strHandler = 'Handler';
$strHasBeenAltered = 'Ã¨ stato modificato.';
$strHasBeenCreated = 'Ã¨ stato creato.';
...
$strHostEmpty = 'Il nome di host Ã¨ vuoto!';
$strHost = 'Host';
...
$strImport = 'Importa';
$strIndexes = 'Indici';
$strIndexHasBeenDropped = 'L\'indice %s Ã¨ stato eliminato';
$strIndex = 'Indice';
$strIndexName = 'Nome dell\'indice&nbsp;:';
$strIndexType = 'Tipo di indice&nbsp;:';
$strIndexWarningMultiple = 'PiÃ¹ di una chiave %s Ã¨ stata creata per la colonna `%s`';
...
$strInsecureMySQL = 'Il file di configurazione in uso contiene impostazioni (root con nessuna password) che corrispondono ai privilegi dell\'account MySQL predefinito. Un server MySQL funzionante con queste impostazioni Ã¨ aperto a intrusioni, e si dovrebbe realmente riparare a questa falla nella sicurezza.';
...
$strInternalNotNecessary = '* Non Ã¨ necessaria una relazione interna quando giÃ  esiste in InnoDB.';
...
$strInvalidRowNumber = '%d non Ã¨ un numero valido di righe.';
...
$strJustDeleteDescr = 'Gli utenti &quot;cancellati&quot; saranno ancora in grado di accedere al servercome al solito finchÃ© i privilegi non verraanno ricaricati.';
...
$strMbExtensionMissing = 'L\'estensione PHP mbstring non Ã¨ stata trovata e sembra che si stia utilizzando un set di caratteri multibyte. Senza l\'estensione mbstring, phpMyAdmin non Ã¨ in grado di dividere correttamente le stringhe di caratteri e questo puÃ² portare a risultati inaspettati.';
$strMbOverloadWarning = 'Avete abilitato mbstring.func_overload nella configurazione del PHP. Questa opzione Ã¨ incompatibile con phpMyAdmin e potrebbe causare la corruzione di alcuni dati!';
...
$strMIME_nodescription = 'Nessuna descrizione Ã¨ disponibile per questa trasformazione.<br />Prego, chiedere all\'autore cosa %s faccia.';
...
$strMIME_transformation_options_note = 'Prego, immettere i valori per le opzioni di trasformazioneutilizzando questo formato: \'a\',\'b\',\'c\'...<br />Se c\'Ã¨ la necessitÃ  di immettere un backslash ("\") o un apostrofo ("\'") tra questi valori, essi vanno backslashati (per es. \'\\\\xyz\' or \'a\\\'b\').';
...
$strModify = 'Modifica';
$strMoveTableOK = 'La tabella %s Ã¨ stata spostata in %s.';
...
$strMyISAMDataPointerSizeDesc = 'Dimensione del puntatore predefinito in Bytes, che deve essere usata da CREATE TABLE per le tabelle MyISAM quando non Ã¨ stata specificata l\'opzione MAX_ROWS.';
$strMyISAMDataPointerSize = 'Domensione del puntatore dati';
$strMyISAMMaxExtraSortFileSizeDesc = 'Se il file temporaneo Ã¨ usato per la creazione veloce di un indice MyISAM, occuperebbe piÃ¹ spazio dell\'utilizzo del metodo key cache con la quantitÃ  ivi specificata: perciÃ² si deve prediligere il metodo key cache.';
$strMyISAMMaxExtraSortFileSize = 'Dimensione massima per i files temporanei nella creazione di un indice';
$strMyISAMMaxSortFileSizeDesc = 'La dimensione massima dei file temporanei MySQL puÃ² essere utilizzata nella rigenerazione di un indice MyISAM (durante un REPAIR TABLE, ALTER TABLE, o LOAD DATA INFILE).';
$strMyISAMMaxSortFileSize = 'Dimensione massima dei file temporanei di ordinamento';
$strMyISAMRecoverOptionsDesc = 'La modalitÃ  di irppristino automatico di tabelle MyISAM corrotte, come impostato tramite l\'opzione di lan cio del server --myisam-recover.';
$strMyISAMRecoverOptions = 'ModalitÃ  di ripristino automatico';
$strMyISAMRepairThreadsDesc = 'Se questo valore Ã¨ maggiore di 1, gli indici della tabella MyISAM vengono creati in parallelo (ogni indice nel suo thread) durante il processo di ordinamento Repair by.';
...
$strName = 'Nome';
$strNext = 'Prossimo';
$strNoActivity = 'Nessuna attivitÃ  da %s secondi o piÃ¹, si prega di autenticarsi nuovamente';
$strNoDatabases = 'Nessun database';
$strNoDatabasesSelected = 'Nessun database selezionato.';
$strNoDescription = 'nessuna Description';
$strNoDetailsForEngine = 'Non Ã¨ disponibile nessuna informazione dettagliata sullo stato di questo motore di memorizzazione.';
...
$strNotNumber = 'Questo non Ã¨ un numero!';
$strNotOK = 'non OK';
...
$strPasswordChanged = 'La password per l\'utente %s Ã¨ cambiata con successo.';
$strPasswordEmpty = 'La password Ã¨ vuota!';
...
$strPHP40203 = 'Si sta utilizzando PHP 4.2.3, che presenta un serio bug con le stringhe multi-byte (mbstring). Vedi report PHP 19404. Questa versione di PHP non Ã¨ raccomandata per l\'utilizzo con phpMyAdmin.';
...
$strPrimaryKeyHasBeenDropped = 'La chiave primaria Ã¨ stata eliminata';
...
$strPrivDescMaxConnections = 'Limita il numero di nuove connessioni che un utente puÃ² aprire in un\'ora.';
$strPrivDescMaxQuestions = 'Limita il numero di queries che un utente puÃ² mandare al server in un\'ora.';
$strPrivDescMaxUpdates = 'Limita il numero di comandi che possono cambiare una tabella o un database che un utente puÃ² eseguire in un\'ora.';
$strPrivDescMaxUserConnections = 'Limite di connessioni simultanee che un utente puÃ² fare.';
...
$strPrivDescSuper = 'Permette altre connessioni, anche se Ã¨ stato raggiunto il massimo numero di connessioni; Necessario per molte operazioni di amministrazione come il settaggio di variabili globali o la cancellazione dei threads di altri utenti.';
...
$strRecords = 'Record';
$strReferentialIntegrity = 'Controlla l\'integritÃ  delle referenze:';
$strRefresh = 'Aggiorna';
$strRelationalSchema = 'Schema relazionale';
$strRelationNotWorking = 'Le caratteristiche aggiuntive sono state disattivate per funzionare con le tabelle linkate. Per scoprire perchÃ© clicca %squi%s.';
...
$strRenameDatabaseOK = 'Il DataBase %s Ã¨ stato rinominato in %s';
$strRenameTableOK = 'La tabella %s Ã¨ stata rinominata %s';
...
$strRevokeAndDeleteDescr = 'Gli utenti UTILIZZERANNO comunque il privilegio finchÃ© i privilegi non saranno ricaricati.';
...
$strRowsModeOptions = ' in modalitÃ  %s e ripeti gli headers dopo %s celle ';
...
$strSave = 'Salva';
$strScaleFactorSmall = 'Il fattore di scala Ã¨ troppo piccolo per riempire lo schema nella pagina';
$strSearch = 'Cerca';
...
$strSearchType = 'Trova:';
$strSecretRequired = 'Adesso c\'Ã¨ bisogno di una password per il file di configurazione (blowfish_secret).';
...
$strSetEnumVal = 'Se il tipo di campo Ã¨ "enum" o "set", immettere i valori usando il formato: \'a\',\'b\',\'c\'...<br />Se comunque dovete mettere dei backslashes ("\") o dei single quote ("\'") davanti a questi valori, backslashateli (per esempio \'\\\\xyz\' o \'a\\\'b\').';
...
$strShowStatusCreated_tmp_disk_tablesDescr = 'Il numero delle tabelle temporanee create automaticamente sul disco dal server mentre esegue i comandi. Se il valore Created_tmp_disk_tables Ã¨ grande, potresti voler aumentare il valore tmp_table_size, per fare im modo che le tabelle temporanee siano memory-based anzichÃ¨ disk-based.';
...
$strShowStatusDelayed_insert_threadsDescr = 'Il numero di processi INSERT DELAYED in uso. Ciascuna tabella su cui Ã¨ usato INSERT DELAYED occupa un thread.';
...
$strShowStatusHandler_deleteDescr = 'Il numero di volte in cui una riga Ã¨ stata cancellata da una tabella.';
$strShowStatusHandler_discoverDescr = 'Il server MySQL puÃ² chiedere al motore di storage NDB Cluster se conosce una tabella sulla base di un nome dato. Questo Ã¨ chiamato discovery. Handler_discover indica il numero di volte che una tabella Ã¨ stata trovata.';
$strShowStatusHandler_read_firstDescr = 'Il numero di volte che il primo valore Ã¨ stato letto da un indice. Se Ã¨ troppo alto Ã¨ probabile che il server stia facendo molte scansioni complete degli indici; per esempio, SELECT col1 FROM foo, assumendo che col1 sia indicizzata.';
$strShowStatusHandler_read_keyDescr = 'Il numero di richieste per leggere una riga basata su di una chiave. Se Ã¨ alta, Ã¨ un buon indice che le tue query e le tue tabelle sono correttamente indicizzate.';
$strShowStatusHandler_read_nextDescr = 'Il numero di richieste per leggere la riga successiva nell\'ordine delle chiavi. Questo valore Ã¨ incrementato se stai facendo una query su di una colonna indice con un range costante, oppure se stai facendo una scansione degli indici.';
$strShowStatusHandler_read_prevDescr = 'Il numero di richieste per leggere la riga precedente nell\'ordine delle chiavi. Questo metodo di lettura Ã¨ principalmente utilizzato per ottimizzare ORDER BY ... DESC.';
$strShowStatusHandler_read_rndDescr = 'Il numero di richieste per leggere una riga basata su una posizione fissa. Questo valore Ã¨ alto se stai facendo molte richieste che richiedono un ordinamento dei risultati. Probabilmente hai molte query che che richiedono a MySQL di leggere l\'intera tabella oppure ci sono dei joins che non usano le chiavi correttamente.';
$strShowStatusHandler_read_rnd_nextDescr = 'Il numero di richieste per leggere la riga successiva in un file di dati. Questo valore Ã¨ alto se stai facendo molte scansioni della tabella. Generalmente Ã¨ un segnale che le tue tabelle non sono correttamente indicizzate, o che le query non sono state scritte per trarre vantaggi dagli indici che hai.';
...
$strShowStatusInnodb_buffer_pool_pages_miscDescr = 'Il numero di pagine occupate perchÃ¨ sono state allocate per amministrazione, come row locks o per hash index adattivi. Questo valore puÃ² essere calcolato come Innodb_buffer_pool_pages_total - Innodb_buffer_pool_pages_free - Innodb_buffer_pool_pages_data.';
...
$strShowStatusInnodb_buffer_pool_readsDescr = 'Il numero di richieste logiche che InnoDB non puÃ² soddisfare dal buffer pool e che devono fare una lettura di una pagina singola.';
$strShowStatusInnodb_buffer_pool_wait_freeDescr = 'Normalmente le scritture nel buffer pool InnoDB vengono effettuate in background. Tuttavia se Ã¨ necessario leggere o creare una pagina, e non sono disponibile pagine pulite Ã¨ necessario attendere che le pagine siano aggiornate prima. Questo contatore conta le istanze di queste attese. Se la dimensione del buffer pool Ã¨ stata settata correttamente questo valore dovrebbe essere basso.';
...
$strShowStatusInnodb_data_readDescr = 'La quantitÃ  di dati letti fino ad ora, in bytes.';
...
$strShowStatusInnodb_data_writtenDescr = 'La quantitÃ  di dati scritti fino ad ora, in bytes.';
...
$strShowStatusInnodb_log_waitsDescr = 'Il numero di attese che abbiamo avuto perchÃ¨ il buffer di log era troppo piccolo e abbiamo duvuto attendere che fosse aggiornato prima di continuare.';
...
$strShowStatusKey_blocks_unusedDescr = 'Il numero di blocchi non usati nella cache chiave. Puoi usare questo valore per determinare quanta cache chiave Ã¨ in uso.';
$strShowStatusKey_blocks_usedDescr = 'Il numero di blocchi usati nella cache chiave. Questo valore Ã¨ un\'importante segnale che indica il numero massimo di blocchi che sono stati in uso contemporaneamente.';
$strShowStatusKey_read_requestsDescr = 'Il numero di richieste per leggere un blocco chiave dalla cache.';
$strShowStatusKey_readsDescr = 'Il numero di letture fisiche dal disco di un blocco chiave. Se Key_reads Ã¨ grande allora il valore key_buffer_size Ã¨ probabilmente troppo piccolo. Il rapporto di cache miss rate puÃ² essere calcolato come Key_reads/Key_read_requests.';
...
$strShowStatusLast_query_costDescr = 'Il costo totale dell\'ultima query compilata cosÃ¬ come computato dall\'ottimizzatore delle query. Utile per comparare il costo di differenti query per la stessa operazione di query. Il valore di default Ã¨ 0, che significa che nessuna query Ã¨ stata ancora compilata.';
$strShowStatusNot_flushed_delayed_rowsDescr = 'In numero di righe in attesa di essere scritte nella coda INSERT DELAY.';
$strShowStatusOpened_tablesDescr = 'Il numero di tabelle che sono state aperte. Se il valore opened_tables Ã¨ grande, probabilmente il valore di table cache Ã¨ troppo piccolo.';
...
$strShowStatusQcache_lowmem_prunesDescr = 'Il numero di query che sono state rimosse dalla cache per liberare memoria per la cache di nuove query. Questa informazione puÃ² aiutarti per parametrare la dimensione della cache delle query. La cache delle query usa una strategia di "meno usate recentemente" (LRU - least recently used) per decidere quali query rimuovere dalla cache.';
$strShowStatusQcache_not_cachedDescr = 'Il numero di query non in cache (impossibilitÃ  di inserirle nella cache oppure non inserite per i settaggi del parametro query_cache_type).';
...
$strShowStatusSelect_full_joinDescr = 'Il numero di joins che non usano gli indici. (Se questo valore non Ã¨ 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
...
$strShowStatusSelect_range_checkDescr = 'Il numero di joins senza chiavi che controllano per l\'uso di una chiave dopo ogni riga. (Se questo valore non Ã¨ 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
$strShowStatusSelect_rangeDescr = 'Il numero di joins che usano un range sulla prima tabella. (Non Ã¨, solitamente, un valore critico anche se Ã¨ grande.)';
...
$strShowStatusSlave_runningDescr = 'Questa chiave Ã¨ ON se questo Ã¨ un server slave connesso ad un server master.';
$strShowStatusSlow_launch_threadsDescr = 'Numero di processi che hanno impiegato piÃ¹ di "slow_launch_time" secondi per partire.';
$strShowStatusSlow_queriesDescr = 'Numero di query che hanno impiegato piÃ¹ di "long_query_time" seconds.';
$strShowStatusSort_merge_passesDescr = 'Il numero di passaggi di fusione che l\'algoritmo di ordinamento ha dovuto fare. Se questo valore Ã¨ grande, dovresti incrementare la variabile di sistema sort_buffer_size.';
...
$strShowStatusTable_locks_immediateDescr = 'Il numero di volte che un table lock Ã¨ stato eseguito immediatamente.';
$strShowStatusTable_locks_waitedDescr = 'Il numero di volte che un table lock Ã¨ stato eseguito immediatamente ed era necessaria un\'attesa. Se Ã¨ alto, potresti avere dei problemi con le performance, dovresti prima ottimizzare le query, oppure sia utilizzare le repliche, sia dividere le tabelle.';
$strShowStatusThreads_cachedDescr = 'Il numero dei processi nella cache dei processi. L\'hit rate della cache puÃ² essere calcolato come processi_creati/connessioni. Se questo valore Ã¨ rosso devi aumentare la tua thread_cache_size.';
$strShowStatusThreads_connectedDescr = 'Il numero di connessioni correntemente aperte.';
$strShowStatusThreads_createdDescr = 'Il numero di processi creati per gestire le connessioni. Se Threads_created Ã¨ grosso, devi probabilmente aumentare il valore thread_cache_size. (Normalmente questo non fornisce un significativo incremento delle performace se hai una buona implementazione dei processi.)';
...
$strSocketProblem = '(o il socket del server locale MySQL non Ã¨ correttamente configurato)';
...
$strSQLExportCompatibility = 'CompatibilitÃ  dell\'esportazione SQL';
$strSQLExportType = 'Tipo di esportazione';
$strSQLOptions = 'Opzioni SQL';
$strSQLParserBugMessage = 'C\'Ã¨ la possibilitÃ  che ci sia un bug nel parser SQL. Per favore, esaminate la query accuratamente, e controllate che le virgolette siano corrette e non sbagliate. Altre possibili cause d\'errori possono essere che si stia cercando di uploadare un file binario al di fuori di un\'area di testo virgolettata. Si puÃ² anche provare la query MySQL dalla riga di comando di MySQL. L\'errore qui sotto restituito dal server MySQL, se ce n\'Ã¨ uno, puÃ² anche aiutare nella diagnostica del problema. Se ci sono ancora problemi, o se il parser SQL di phpMyAdmin sbaglia quando invece l\'interfaccia a riga di comando non mostra problemi, si puÃ² ridurre la query SQL in ingresso alla singola query che causa problemi, e inviare un bug report con i dati riportati nella sezione CUT qui sotto:';
$strSQLParserUserError = 'Pare che ci sia un errore nella query SQL immessa. L\'errore del server MySQL mostrato qui sotto, se c\'Ã¨, puÃ² anche aiutare nella risoluzione del problema';
...
$strSubmit = 'Invia';
$strSuccess = 'La query Ã¨ stata eseguita con successo';
$strSum = 'Totali';
$strSwedish = 'Svedese';
$strSwitchToDatabase = 'Passare al Database copiato';
$strSwitchToTable = 'Passa alla tabella copiata';

$strTableAlreadyExists = 'La tabella %s esiste giÃ !';
$strTableComments = 'Commenti sulla tabella';
$strTableEmpty = 'Il nome della tabella Ã¨ vuoto!';
$strTableHasBeenDropped = 'La tabella %s Ã¨ stata eliminata';
$strTableHasBeenEmptied = 'La tabella %s Ã¨ stata svuotata';
$strTableHasBeenFlushed = 'La tabella %s Ã¨ stata inizializzata';
...
$strTextAreaLength = ' A causa della sua lunghezza,<br /> questo campo non puÃ² essere modificato ';
$strThai = 'Thai';
$strTheme = 'Tema / Stile';
$strThisHost = 'Questo Host';
$strThisNotDirectory = 'Questa non Ã¨ una directory';
$strThreads = 'Processi';
$strThreadSuccessfullyKilled = 'Il thread %s Ã¨ stato terminato con successo.';
$strTimeoutInfo = 'Una precedente importazione Ã¨ entrata in timeout, dopo un nuovo inoltro riprenderÃ  dalla posizione: %d.';
$strTimeoutNothingParsed = 'Nell\'ultima esecuzione nessun dato Ã¨ stato processato, questo, solitamente, vuole dire che che phpMyAdmin non Ã¨ in grado di ultimare l\'operazione fino a che non verrÃ  aumentato il parametro php time limits.';
$strTimeoutPassed = 'Superato il tempo limite dello script, se vuoi finire l\'importazione inoltra nuovamente il file e il processo riprenderÃ .';
$strTime = 'Tempo';
...
$strTransformation_application_octetstream__download = 'Visualizza un collegamento per trasferire i dati di un campo in formato binario.  La prima opzione Ã¨ il nome del file binario.  La seconda opzione Ã¨ un nome di campo possibile di una riga della tabella che contiene il nome di schedario.  Se fornite una seconda opzione dovete avere la prima opzione settata ad una stringa vuota';
...
$strTransformation_text_plain__dateformat = 'Prende un campo TIME, TIMESTAMP o DATETIME e lo formatta utilizzando il formato data locale. La prima opzione Ã¨ il time offset (in ore) il quale sarÃ  aggiunto al timestamp (Predefinito: 0). La seconda opzione Ã¨ un formato data in linea con i parametri disponibili per la funzione strftime() del PHP.';
$strTransformation_text_plain__external = 'SOLO PER LINUX: Lancia un\'applicazione esterna e riempie i dati dei campi tramite lo standard input. Restituisce lo standard output dell\'applicazione. L\'impostazione predefinita Ã¨ Tidy, per stampare in maniera corretta il codice HTML. Per motivi di sicurezza, dovete editare manualmente il file libraries/transformations/text_plain__external.inc.php e inserire gli strumenti che permettete di utilizzare. La prima opzione Ã¨ cosÃ¬ il numero del programma che volete utilizzare e la seconda sono i parametri per il programma. Il terzo parametro, se impostato a 1 convertirÃ  l\'output utilizzando htmlspecialchars() (Predefinito: 1). Un quarto parametro, se impostato a 1 inserirÃ  un NOWRAP al contenuto della cella cosÃ¬ che l\'intero output sarÃ  mostrato senza essere riformattato (Predefinito: 1)';
$strTransformation_text_plain__formatted = 'Preserva l\'originale formattazione del campo. Nessun Escaping viene applicato.';
$strTransformation_text_plain__imagelink = 'Mostra un collegamento ad una immagine esterna; il campo contiene il nome del file; la prima opzione Ã¨ un prefisso come "http://tuodominio.com/", la seconda opzione Ã¨ la larghezza in pixel, la terza Ã¨ l\'altezza.';
$strTransformation_text_plain__link = 'Mostra un collegamento, il campo contiene il nome del file; la prima opzione Ã¨ un prefisso come "http://tuodominio.com/", la seconda opzione Ã¨ un titolo per il collegamento.';
$strTransformation_text_plain__sql = 'Formatta il testo come query SQL con evidenziazione della sintassi.';
$strTransformation_text_plain__substr = 'Mostra soltanto una parte della stringa. La prima opzione Ã¨ l\'offset che serve a definire dove inizia l\'output del vostro testo (Predefinito: 0). La seconda opzione Ã¨ un offset che indica quanto testo viene restituito. Se vuoto, restituisce tutto il testo rimanente. La terza opzione definisce quali caratteri saranno aggiunti in fondo all\'output quando una soptto-stringa viene restituita (Predefinito: ...) .';
...
$strUnsupportedCompressionDetected = 'Stai cercando di importare un file con un tipo di compressione non supportato. Altrimenti il supporto per questo tipo di compressione non Ã¨ stato ancora implementato o Ã¨ stato disabilitato dalla tua configurazione.';
$strUpdatePrivMessage = 'Hai aggiornato i permessi per %s.';
$strUpdateProfileMessage = 'Il profilo Ã¨ stato aggiornato.';
...
$strUserAlreadyExists = 'L\'utente %s esiste giÃ !';
$strUserEmpty = 'Il nome utente Ã¨ vuoto!';
$strUserName = 'Nome utente';
$strUserNotFound = 'L\'utente selezionato non Ã¨ stato trovato nella tabella dei privilegi.';
...
$strValidatorError = 'L\' SQL validator non puÃ² essere inizializzato. Prego controllare di avere installato le estensioni php necessarie come descritto nella %sdocumentazione%s.';
$strValue = 'Valore';
$strVar = 'Variabile';
...
$strViewHasBeenDropped = 'La vista %s Ã¨ stata eliminata';
$strView = 'Vista';

$strWebServerUploadDirectory = 'directory di upload del web-server';
$strWebServerUploadDirectoryError = 'La directory impostata per l\'upload non puÃ² essere trovata';
$strWelcome = 'Benvenuto in %s';
$strWestEuropean = 'Europeo Occidentale';
$strWildcard = 'wildcard';
$strWindowNotFound = 'La finestra destinataria del browser non puÃ² essere aggiornata. PuÃ² darsi che sia stata chiusa la finestra madre o che il vostro browser stia bloccando gli aggiornamenti fra browsers a causa di qualche impostazione di sicurezza';
