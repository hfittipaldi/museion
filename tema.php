...
var i = qual.value;
document.location=('tema.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('tema.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from tema";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from tema as a order by nome asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;T&iacute;tulo
              do Tema </div></td>
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['tema'] ?>">
          <td colspan="2" align="justify"><? echo $row[nome] ?></td>
          <td align="center" width='12%'><? echo "<a href=\"tema1.php?op=del&tema=".base64_encode($row['tema'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[tema]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[tema]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"tema1.php?op=update&tema=".base64_encode($row['tema'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[tema]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"tema1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"tema.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"tema.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"tema.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"tema.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
$g= " Total de temas cadastrados: $numlinhas - Página: $page_atual de $numpages $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="tema" type="hidden" id="tema" value="<? echo $tema ?>">
