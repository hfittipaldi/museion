      ...
      <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="2" >
       ...
       <?}
        ...
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td align="center"><? echo "<a href=\"exposicao_insere2.php?op=insert&".$parametro."=".$valor."\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Adicionar exposição'>"?></td>
        </tr>
          <tr>
