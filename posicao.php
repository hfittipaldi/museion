...
var i = qual.value;
document.location=('posicao.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('posicao.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from posicao";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from posicao as a order by posicao asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Descrição </div></td>
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['posicao'] ?>">
          <td colspan="2" align="justify"><? echo $row['posicao']." - ".$row['descricao'] ?></td>
          <td align="center" width='12%'><? echo "<a href=\"posicao1.php?op=del&posicao=".base64_encode($row['posicao'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[posicao]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[posicao]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"posicao1.php?op=update&posicao=".base64_encode($row['posicao'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[posicao]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"posicao1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"posicao.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"posicao.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"posicao.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"posicao.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de posições cadastradas: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="posicao" type="hidden" id="posicao" value="<? echo $posicao ?>">
