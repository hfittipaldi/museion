...
<body>
<table width="537"  border="0" align="left" cellpadding="0" cellspacing="8" >
  <tr>
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  order by tombo + 0, tombo, seq_restauro, autor LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td width="62%" height="24" bgcolor="#96ADBE" class="texto_bold"><div align="left"> &nbsp;&nbsp;Ocorr&ecirc;ncias
              encontradas para:
            <?  echo "<font color='FFFFFF'>&nbsp;".ucfirst($_REQUEST[autor])."</font>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>            
            <div align="left"></div>            <div align="center"></div>            <div align="center"></div></td>
          <td width="38%" bgcolor="#96ADBE" class="texto_bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registro
            - Restaura&ccedil;&atilde;o</td>
        </tr>
        <tr>
	  ...
	  ?>
        <tr class="texto">
          <td colspan="3" align="justify"><? echo $row[autor] ?> - <B><? echo $row[titulo]; ?></B>            <div align="left">
            </div>            <div align="center"></div></td>
          <td width="11%" align="center"><? echo $row[tombo] ?></td>
