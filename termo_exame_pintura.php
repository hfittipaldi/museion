...
var i = qual.value;
document.location=('termo_exame_pintura.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('termo_exame_pintura.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from termo_pintura_exames";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from termo_pintura_exames as a order by termo_pintura_exames asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
	  ...
	  {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['termo_pintura_exames'] ?>">
          <td colspan="2" align="justify"><? echo $row['termo'] ?></td>
          <td align="center" width='12%'><? echo "<a href=\"termo_exame_pintura1.php?op=del&tratamento=".$row['termo_pintura_exames']."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[termo_pintura_exames]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[termo_pintura_exames]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='12%'><? echo "<a href=\"termo_exame_pintura1.php?op=update&tratamento=".$row['termo_pintura_exames']."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[termo_pintura_exames]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"termo_exame_pintura1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"termo_exame_pintura.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"termo_exame_pintura.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"termo_exame_pintura.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"termo_exame_pintura.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
