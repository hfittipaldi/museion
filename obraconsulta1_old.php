  ...
  //  echo "<br>";
	  ...
	  ?>
          <tr class="texto"> 
            ...
            <td width="70%" align="justify" valign="top" class="texto_bold" style="font-weight:normal; cursor:pointer;" onClick="abre_pagina('<? echo $row[obra]; ?>','<? echo htmlentities(str_replace("'","`",$row[titulo]), ENT_QUOTES); ?>');"> 
	...
	?>
		...
		<form name="frm_imprime" method="post">
			...
			&nbsp;&nbsp;<a href="javascript:;" style="text-decoration: none;" onClick="abrepop3('pre_impressao_resumida.php');"><sub><img src="imgs/icons/ic_ficha_res.gif" border="0" title="Gravar/imprimir ficha resumida"></sub></a>
...
<tr><td colspan="2" align="center" nowrap class="texto" style="border-top: 1px solid #96ADBE;">
      ...
      <?
          ...
          echo $comando;
      ?>
            <img src='imgs/icons/lupa.gif'  border='0'  alt='Localiza Obra pelo Num. de Registro' ></a>
</td></tr>
</table>
