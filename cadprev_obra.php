...
//Obs: Para nao confundir,a variavel nomeetiqueta='nome do autor da obra';
 ...
 //
 // Criando statusInicial (Inclusão de Obra com Publicação). Mais abaixo, na chamada do cadastrobra.php passando este parâmetro (PBL) PRD17
 //
 ...
 $db->query($sql);
  ...
  { 
	 ...
	 if(ok)
	 window.location='cadastrobra.php?op=insert&num=$num&statusInicial=$statusInicial';
	 </script>";
