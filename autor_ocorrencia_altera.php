	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['autor'] ?>">
          ...
          <td align="center" width='15%'>
            <div align="center"><? echo "<a href=\"alterarautor.php?op=update&id=".$row[autor]."&autid=".$row[autor]."\">
...
$a="<a href=\"autor_ocorrencia_altera.php?page=".$first."&nomeetiqueta=".$_REQUEST[nomeetiqueta]."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"autor_ocorrencia_altera.php?page=".$menos."&nomeetiqueta=".$_REQUEST[nomeetiqueta]."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"autor_ocorrencia_altera.php?page=".$mais."&nomeetiqueta=".$_REQUEST[nomeetiqueta]."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"autor_ocorrencia_altera.php?page=".$last."&nomeetiqueta=".$_REQUEST[nomeetiqueta]."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
?></td>
    ...
    &nbsp;<? echo "<a href='autor.php'><img src='imgs/icons/btn_voltar.gif' width='20' height='20' border='0' alt='Voltar'></a>"?></td>
  </tr>
</table>
