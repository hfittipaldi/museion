...
<table width="452"  border="0" align="left" cellpadding="0" cellspacing="8" >
  <tr>
    <td width="436" valign="top"><form name="form1" method="post" action="">
        ...
        <tr bgcolor="#96ADBE">
          <td height="24" colspan="4" bgcolor="#CCCCFF" class="texto_bold">Selecione
            o tipo da exposi&ccedil;&atilde;o:
            <?php
				//Paginando (NO ARRANJO HAVERÁ PAGINAÇÃO CORRIDA e SELEÇÃO DE NÍVEL)//
	$pagesize=10;
	$page=1;
	if(!empty($_GET['page']))
		$page=$_GET['page'];
	...
	if(!empty($_GET['tipo']))
        ...
        <tr bgcolor="#96ADBE">
          <td width="66%" height="24" bgcolor="#96ADBE" class="texto_bold"><div align="left">&nbsp;&nbsp;Nome</div></td>
          <td width="16%" bgcolor="#96ADBE" class="texto_bold"><div align="center">Tipo</div></td>
		...
		<? while($row=$db->dados())
			{ ?>
               <tr class="texto">
                 ...
                 <td class="texto_bold" align="center"><? echo $row[tipo] ?>
                 <div align="center"></div></td>
                 <td class="texto_bold" align="center"><? } ?></td>
                 <td align="center" class="texto_bold">&nbsp;</td>
               </tr>
          <tr class="texto">
          <td colspan="4" class="texto_bold"><?php
