...
document.location=('acervo_autor.php?page='+i);
}}

function posiciona(valor) {
var i = valor;
document.location=('acervo_autor.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
    ...
    <?
	 ...
	 ?>
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          <td height="24" bgcolor="#96ADBE" class="texto_bold">&nbsp;&nbsp;Autor <div align="center"></div></td>
	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row[autor] ?>">
          <td align="justify"><b>&nbsp;<? echo $row[nomeetiqueta] ?></b> 
			</td>
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[autor]."\").style.backgroundColor=\"\";'>";} ?>
        ...
        <tr class="texto">
          <td colspan="7" class="noprint"><? if ($_REQUEST[pagesize] < 999) echo "<a target='_blank' href=\"acervo_autor.php?page=1&pagesize=999999\"><img src='imgs/icons/ic_salvar_impressao.gif'  border='0'  alt='Versão para impressão'></a>" ?></td>
        </tr>
        <tr>
...
$a="<a href=\"acervo_autor.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial'></a>";

$b="<a href=\"acervo_autor.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior'></a>";

$c="<a href=\"acervo_autor.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro'></a>";

$d="<a href=\"acervo_autor.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro'></a>";
...
$g= " ".$tot_geral[0]." obras de ".$numlinhas." autores ".$txtpagina.$a."&nbsp".$b."&nbsp".$c."&nbsp".$d."";
echo"&nbsp";
