...
//	  $pagesize=1;
	  ...
	  /////////////////////
	  $sql2="SELECT a.*,b.titulo as tit,b.fotografia as foto, b.fotografia as foto,b.forma_exibicao from fotografia_obra as a, fotografia as b where (a.fotografia = b.fotografia)
