...
var i = qual.value;
document.location=('consulta_movimento_obra.php?id=<? echo $_REQUEST[id] ?>&page='+ i);
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="8" >
 ...
 <?
	 ...
	 $sql="SELECT count(*) as total from obra_movimentacao where obra='$_REQUEST[id]'";
	  $db->query($sql);
	  $numlinhas=$db->dados();
	  ...
	  $sql2="SELECT a.data_saida as saida_obra,a.data_retorno as retorno_obra,b.* from obra_movimentacao as a inner join movimentacao as b on(a.movimentacao=b.movimentacao) 
	   		where a.obra='$_REQUEST[id]' order by b.data_saida desc LIMIT $registroinicial,$pagesize ";
	  $db->query($sql2);
	  ////////////////////
...
$a="<a href=\"consulta_movimento_obra.php?id=$_REQUEST[id]&page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"consulta_movimento_obra.php?id=$_REQUEST[id]&page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"consulta_movimento_obra.php?id=$_REQUEST[id]&page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"consulta_movimento_obra.php?id=$_REQUEST[id]&page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de movimentações da obra: $numlinhas - Página: $page_atual de $numpages &nbsp $lista_combo &nbsp;
