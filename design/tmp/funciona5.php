...
.clLevel1{background-color:; layer-background-color:; color:black;}
...
//Menu properties   
oCMenu.pxBetween=0
oCMenu.fromLeft=165; //Define a posicao do menu na pagina:ver configuracao para 800x600 e 1024x768
oCMenu.fromTop=165   
oCMenu.rows=0 
