...
{
//Funcao para evitar ocorrer um insert/update 
//gerando registros duplicados na base
...
chamada='$_REQUEST[chamada]',posicao='$posicao',ordenacao='$ordem' where item='$item'";
$db->query($sql);
