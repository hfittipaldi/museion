     ...
     <table width="100%"  border="0" cellpadding="0" cellspacing="8" >
        ...
        <tr>
          ...
          <td nowrap class="texto_bold" align="right" colspan="2">
            ...
            <input name="numregistro" type="text" class="combo_cadastro" style="display:<? echo ""; ?>; id="numregistro"  value="<? echo htmlentities(str_replace("\\","", $numregistro), ENT_QUOTES); ?>" size="15"></div>
          </td>
        </tr>
         <tr><td nowrap class="texto_bold" align="center" colspan="2">&nbsp;</td>

         <td nowrap class="texto_bold" align="center" colspan="2">                 
        ...
        <tr>
           ...
           <td nowrap class="texto_bold" align="right" colspan="2">                 
                 <label id="rotulo_moldura" class="texto_bold"align="right" style="display:<?  echo "none"; ?>;">N&ordm; da moldura:</label>
...
if ($_REQUEST[submit_moldura]<>'')
{
  ...
  if($_REQUEST[numregistro]<>'') 
   ...
   {
      global $db;
      $sql="SELECT a.interna, a.moldura, a.mold_registro, a.parte, a.obra from moldura as a where  a.mold_registro='".trim($_REQUEST[moldura])."'";
      $db->query($sql);
      $conta=$db->dados();
      $parte=$conta['parte'];
      $obra=$conta['obra'];
      ...
      if ($obra>0){$tipo_2=1;}else{$tipo_2=2;}
      if ($obra<1) {if ($interna=='I'){$tipo_2=1;}else{$tipo_2=2;}}
...
//########################### é moldura ###################################      
   ...
   if ($_REQUEST[tipo]=='4')
   {
         ...
         if ( $_REQUEST[moldura]<>'' and $_REQUEST[numregistro]=='')
          {
             ...
             if ($moldura>0){
               ...
               if ($_REQUEST[tipo2]=='I' and $_REQUEST[numregistro]<1 )
                 {
                  echo "<script>location.href='restauracao_moldura_externa.php?op=insert&tipo2=1&tipo=$_REQUEST[tipo]&pNum_registro=$_REQUEST[numregistro]&pId_parte=$parte&controle=$controle&moldura=$moldura&mold_registro=$num';</script>";       
                 }
               }

          }///////////// se moldura for diferente de nulo e registro igual a nulo/////////////////////////////
        ...
        }//////////////////se moldura igual a nulo e registro diferente de nulo////////////////////////////////




 
      if ($_REQUEST[tipo2]=='I' and $_REQUEST[numregistro]< 1 and  $_REQUEST[moldura] < 1)
          {
            echo "<script>location.href='restauracao_moldura_interna.php?op=insert&tipo2=1&tipo=$_REQUEST[tipo]&pNum_registro=$_REQUEST[numregistro]&pId_parte=$parte&controle=$controle&moldura=$moldura&mold_registro=$num';</script>";       
            }
      ...
      if ($_REQUEST[tipo2]=='I' and $_REQUEST[numregistro]>0 )
          {
          echo "<script>location.href='parte_ocorrencia.php?tipo2=1&tipo=$_REQUEST[tipo]&numregistro=$_REQUEST[numregistro]&pNum_registro=$_REQUEST[numregistro]&pId_parte=$parte&controle=$controle';</script>";
          }
 
    
      if  ($_REQUEST[tipo2]=='E')
          {
           echo "<script>location.href='restauracao_moldura_externa.php?tipo2=$tipo_2&tipo=$_REQUEST[tipo]&pNum_registro=$_REQUEST[numregistro]&moldura=$moldura&mold_registro=$num';</script>";       
          }
...
// não pertence ao museu e não ´é moldura
       ...
       echo "<script>location.href='inclusao_restauro.php?tipo2=$tipo2&tipo=$tipo&numregistro=$_REQUEST[numregistro]&moldura=$moldura'</script>";   
}
 ?>