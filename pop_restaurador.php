	       ...
	       if($_REQUEST[submit]<>'') {
			...
			$res=$_REQUEST[usuario];
			 ...
			 for($i=0;$i<count($res);$i++)
			 {
		       ...
		       echo "<script>
						if (opener.window.document.getElementById('assinatura').value == '')
							opener.window.document.getElementById('assinatura').value=opener.window.document.getElementById('assinatura').value + '$k';
						else
							opener.window.document.getElementById('assinatura').value=opener.window.document.getElementById('assinatura').value + ', $k';
					</script>";
