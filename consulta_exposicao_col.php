...
var i = qual.value;
document.location=('consulta_exposicao_col.php?<? echo $parametro; ?>=<? echo $valor; ?>&page='+ i);
}}
</script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="8" >
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	 ...
	 $sql="SELECT count(*) as total FROM exposicao as a  INNER JOIN  ".$tipo."_exposicao as b on (a.exposicao=b.exposicao)
	 where $tipo='$valor' and tipo='C'";
	 $db->query($sql);
	 $numlinhas=$db->dados();
     $numlinhas=$numlinhas[0];
	 
	  ////////////////////
	  $sql2="SELECT a.exposicao as expid,a.nome,a.instituicao,a.estado,a.periodo,a.cidade,b.* FROM exposicao as a  INNER JOIN  ".$tipo."_exposicao as b on (a.exposicao=b.exposicao)
	   where $tipo='$valor' and tipo='C' order by a.dt_inicial,a.nome LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
	  ...
	  ?>
        ...
        <tr class="texto" id="cor_fundo<? echo $row['expid'] ?>">
          ...
          <? } else { ?>
		  <? } ?>
          <td align="center"><? echo "<a href=\"consulta_expo1.php?op=view&tipoexp=C&".$parametro."=".$valor."&id=".$row['expid']."\">
...
$a="<a href=\"consulta_exposicao_col.php?".$parametro."=".$valor."&page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"consulta_exposicao_col.php?".$parametro."=".$valor."&page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"consulta_exposicao_col.php?".$parametro."=".$valor."&page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"consulta_exposicao_col.php?".$parametro."=".$valor."&page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
