...
var i = qual.value;
document.location=('museu.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('museu.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
$_SESSION['lnk']=$link;
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="select count(*) as total from museu";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="select a.* from museu as a order by museu asc limit $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td width="69%" height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;Nº / Nome</div></td>
          <td width="11%" bgcolor="#ddddd5" class="texto_bold"><div align="center">Sigla</div></td>
      ...
      <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="2">
		<? while($row=$db->dados())
	       {
	  ?>
        <tr class="texto" id="cor_fundo<? echo $row['museu'] ?>">
          <td colspan="2" align="justify"><? echo $row[museu] . ". " . $row[nome] ?></td>
          <td width='11%' align="center"><div align="center"><? echo $row[sigla] ?>
            </div></td>
          <td align="center" width='10%'><? echo "<a href=\"museu1.php?op=del&museu=".base64_encode($row['museu'])."\"
	...
	onMouseOver='document.getElementById(\"cor_fundo".$row[museu]."\").style.backgroundColor=\"#ddddd5\";' 
	onMouseOut='document.getElementById(\"cor_fundo".$row[museu]."\").style.backgroundColor=\"\";'>";?>
            <div align="center"></div></td>
          <td align="center" width='10%'><? echo "<a href=\"museu1.php?op=update&museu=".base64_encode($row['museu'])."\">
	 ...
	 onMouseOut='document.getElementById(\"cor_fundo".$row[museu]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td width="27%" align="right"><span class="texto_bold"></span></td>
          <td align='left' width="42%">&nbsp;</td>
          <td>&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"museu1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"museu.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"museu.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"museu.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"museu.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
//echo"$lista_combo";
$g= " Total de Instituições cadastradas: $numlinhas - Página: $page_atual de $numpages $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="est" type="hidden" id="est" value="<? echo $museu ?>">
