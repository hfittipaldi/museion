...
document.location=('bibliografia_manut_detautor.php?page='+ i+ '&id='+ id );
  ...
  <tr>
	...
	$sql3="SELECT referencia,autoria FROM bibliografia 
 	...
 	$db3->query($sql3);
        ...
        // autor
        $sqla="SELECT count(*) as totalautor FROM bibliografia as a INNER JOIN  autor_bibliografia as b on 
                                       (a.bibliografia=b.bibliografia) INNER JOIN autor as c on (b.autor=c.autor) where a.bibliografia=".$_REQUEST[id]." order by a.referencia";
	$dba->query($sqla);
	$anumlinhas=$dba->dados();
        $anumlinhas=$anumlinhas[0];

       //autor
	$sql3="SELECT a.bibliografia as expid,a.referencia,b.autor,c.nomeetiqueta, c.autor 
                            FROM bibliografia as a INNER JOIN  autor_bibliografia as b on (a.bibliografia=b.bibliografia) INNER JOIN autor as c on (b.autor=c.autor) where a.bibliografia=".$_REQUEST[id]. " order by a.referencia LIMIT $registroinicial,$pagesize";
 	$dba->query($sql3);
	?>
...
<body>
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
      <tr>
         <td valign="top"><form name="form1" method="get" onSubmit='true' action="bibliografia_manut_detautor.php">
                 <tr>
                    <table width="100%" height="20"  border="0" cellspan="1" cellpadding="0" cellspacing="0">
                       ...
                       <tr width="100%" bgcolor="#ddddd5">
                       <td width="45%" height="20" bgcolor="#ddddd5" class="texto_bold"><div align="left"> &nbsp;Autor(es)  </div></td>
		       ...
		       <? } ?>
                       ...
                       <? 
                          ...
                          $a="<a href=\"bibliografia_manut_detautor.php?page=".$first."&id=".$expid."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";
                          $b="<a href=\"bibliografia_manut_detautor.php?page=".$menos."&id=".$expid."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";
                          $c="<a href=\"bibliografia_manut_detautor.php?page=".$mais."&id=".$expid."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";
                          $d="<a href=\"bibliografia_manut_detautor.php?page=".$last."&id=".$expid."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
                          $combo="";
