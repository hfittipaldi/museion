  ...
  <tr>
    ...
    <?
	  ...
	  $db->query($sql);
          ...
          $sql3="select o.autor as autor,o.quantidade as quantidade,count(o.quantidade) as total,f.nomeetiqueta as nome from log_pesquisa o,autor f where o.autor=f.autor group by o.autor order by quantidade desc limit 1000";
	 ...
	 ?>
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#96ADBE">
          ...
          <td width="15%" bgcolor="#96ADBE" class="texto_bold"> <div align="center">Num consultas</div></td>
	  ...
	  ?>
        <tr class="texto" id="cor_fundo<? echo "" ?>">
          ...
          <td align="right" width='15%'><? echo $row[quantidade] ?></td>
