...
.clBar{position:absolute; width:10; height:10; background-color:#c4c6c8; layer-background-color:#c4c6c8 visibility:hidden;}
...
.clLevel1{background-color:#b4c6c8; layer-background-color:#b4c6c8; color:black}
...
.clLevel1border{position:absolute; visibility:visible; background-color:#b4c6c8; layer-background-color:#b4c6c8; border-left:1px solid black; border-top:1px solid black}
/*Styles for level 2*/
...
.clLevel2{background-color:#b4c6c8; layer-background-color:#b4c6c8; color:black;}
.clLevel2over{background-color:#596E83; layer-background-color:#596E83; color:white; cursor:pointer; cursor:hand; }
.clLevel2border{position:absolute; visibility:visible; background-color:#b4c6c8; layer-background-color:#b4c6c8;  border:1px solid black}
</style>

<script language="javascript" type="text/javascript">

// Previne erro de alinhamento à direita no FireFox (para resolução 1024x768)
