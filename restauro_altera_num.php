...
var i = qual.value;
document.location=('restauro_altera_num.php?page='+ i + '&num=<? echo $_REQUEST[num] ?>&tipo=<? echo $_REQUEST[tipo] ?> ');
}}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from restauro as a where a.tombo like '$_REQUEST[num]' and a.tipo='$_REQUEST[tipo]'";
	  ...
	  /////////////////////
	  $sql2="SELECT a.* from restauro as a where a.tombo like '$_REQUEST[num]' and a.tipo='$_REQUEST[tipo]' order by a.tombo + 0, a.tombo, a.seq_restauro, a.titulo LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
       ...
       <tr bgcolor="#f4f4f4">
          <td width="60%" height="24" bgcolor="#f4f4f4" class="texto"><div align="left"> &nbsp;&nbsp;Ocorr&ecirc;ncias encontradas para o registro:<?  echo "<b><font color='#000000'>&nbsp;".ucfirst($_REQUEST[num])."</font>"; ?> </div></td>
    ...
    <tr class="texto">
         ...
         <? 
              ...
              if ($pagina=='restauracao_moldura_interna.php'){
                  echo "<a href=\"$pagina?op=update&id=".$row[restauro]."&form=restauro&tipo2=1&form2=alterar&filtro=".$row[tombo]."&chama=registro"."\"><img src='imgs/icons/ic_alterar.gif' width='20' height='20'border='0' alt='Alterar'></a>";
              }else{
...
$a="<a href=\"restauro_altera_num.php?page=".$first."&tipo=".$_REQUEST[tipo]."&num=".$_REQUEST[num]."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"restauro_altera_num.php?page=".$menos."&tipo=".$_REQUEST[tipo]."&num=".$_REQUEST[num]."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"restauro_altera_num.php?page=".$mais."&tipo=".$_REQUEST[tipo]."&num=".$_REQUEST[num]."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"restauro_altera_num.php?page=".$last."&tipo=".$_REQUEST[tipo]."&num=".$_REQUEST[num]."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
