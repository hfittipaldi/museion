...
var i = qual.value;
var id = expid;
var texto='exposicao_manut_detmov.php?page='+ i+ '&id='+ id;

document.location=('exposicao_manut_detmov.php?page='+ i+ '&id='+ id );
  ...
  <tr>
	...
	$sql3="SELECT nome, periodo 
 	...
 	$db3->query($sql3);
        ...
        // movimentacao
        $sqla="SELECT count(*) as totalmov 
               FROM exposicao as a INNER JOIN  movimentacao_exposicao as b on 
               (a.exposicao=b.exposicao) INNER JOIN movimentacao as c on (b.movimentacao=c.movimentacao) 
	...
	$numlinhas=$dba->dados();
       ...
       //movimentacao
	$sql3="SELECT a.exposicao as expid,a.nome,a.instituicao,b.movimentacao,c.movimentacao, c.movimentacao 
               FROM exposicao as a INNER JOIN movimentacao_exposicao as b on 
               (a.exposicao=b.exposicao) INNER JOIN movimentacao as c on (b.movimentacao=c.movimentacao) 
...
<body>
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
      <tr>
         <td valign="top"><form name="form1" method="get" onSubmit='true' action="exposicao_manut_detmov.php">
                 <tr>
                    <table width="100%" height="20"  border="0" cellspan="1" cellpadding="0" cellspacing="0">
                       ...
                       <tr width="100%" bgcolor="#ddddd5">
                       <td width="45%" height="20" bgcolor="#ddddd5" class="texto_bold"><div align="left"> &nbsp;Nº da movimentação  </div></td>
		        ...
		        ?>                  
                    ...
                    <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="2" >
                       ...
                       <? if ($arow['movimentacao']!="") 
                             {?> 
                             <td width="100%"><?echo "<b>".$arow['movimentacao']." ";?></td>
                        <?} else {?>
                            <td width="50%"><?echo "<b>";?></td>
                         <?}?>                         
                         <? if ($arow['finalindade']!="") 
                             {?> 
                             <td width="100%"><?echo "<b>".$arow['finalidade']." ";?></td>
                        <?} else {?>
                            <td width="50%"><?echo "<b>";?></td>
                         <?}?>                         
                       </tr>
		       <? } ?>
                       ...
                       <? 
                          ...
                          $a="<a href=\"exposicao_manut_detmov.php?page=".$first."&id=".$expid."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";
                          $b="<a href=\"exposicao_manut_detmov.php?page=".$menos."&id=".$expid."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";
                          $c="<a href=\"exposicao_manut_detmov.php?page=".$mais."&id=".$expid."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";
                          $d="<a href=\"exposicao_manut_detmov.php?page=".$last."&id=".$expid."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
                          $combo="";
