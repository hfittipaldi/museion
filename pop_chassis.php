...
function seleciona()
{
	if (document.getElementById('selchassis').value != '') {
		opener.window.document.getElementById('chassis').value= document.getElementById('selchassis').value;
	}
	window.close();
}
</script>
      ...
      <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="2" bgcolor="#ddddd5">
        <tr class="texto">
          <td colspan="4" align="center" class="texto">
			<select size="10" name="selchassis" id="selchassis" class="combo_cadastro">
				<option value="adequado">adequado</option>
				<option value="inadequado">inadequado</option>
				<option value="inexistente">inexistente</option>
				<option value="substituido">substitu&iacute;do</option>
			</select>
		  </td>
        </tr>
        <tr class="texto">
