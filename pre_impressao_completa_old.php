...
<? } ?>
<p align="left"> <font style="font-family:times new roman,arial; font-size:32px;"><em>S</em></font><font style="font-family:times new roman,arial; font-size:18px;">imba</font> 
  <strong><font face="Arial, Helvetica, sans-serif">- Ficha completa </font></strong>
<table width="95%"  border="1">
        <tr> 
          <td height="10" colspan="3" style="border-bottom:1px solid #000000;"><img src="imgs/transp.gif" width="10" height="10"></td>
        </tr>
  ...
  <tr>
    <td width="84%"><ol>
        <font face="Arial, Helvetica, sans-serif" size="+1"><? echo $count.". ".$autor[nomeetiqueta]; ?></font><br>
        <?     
			        $nasc='';
...
?>	
  ...
  <td width="16%" valign="top" align="right"><img src="<? echo 'http://'.$_SERVER[SERVER_ADDR].'/donato/'.$dir_virtual.$url.'/'.combarra_encode($arquivo); ?>" height="<? echo $Ao; ?>" width="<? echo $Lo; ?>"></img></td>
  </tr>
    <td 
      <?
					echo "</font>";
    ...
    <td height="10" colspan="3" style="border-bottom:1px solid #96ADBE;"><img src="imgs/transp.gif" width="10" height="10">
      <?
					echo "</font>";
					echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><br>Nº de inventário: <b>" . $row['inventario']." ". $row['controle_inv'] . "</b><br></em>";
					echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><br>Coleção: <b>" . ret_colecao_obra($row[obra]) . "</b><br></em>";
					if ($row['desc_conteudo'] <> '') {
						if ($_POST['modelo']=='2' || $_POST['modelo']=='4')
							echo "<font style='font-family:arial; font-weight:normal; font-size:12px;'><br><em><b>DESCRIÇÃO:<br></em></b>" . $row['desc_conteudo'] . "<br></em></font>";
					}
