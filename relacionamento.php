...
var i = qual.value;
document.location=('relacionamento.php?page='+ i);
}}

function posiciona(valor) {
var i = valor;
document.location=('relacionamento.php?page='+ i+ '&titulo=<? echo $_REQUEST[titulo] ?>&vinculo=<? echo $_REQUEST[vinculo] ?>&funcao=<? echo $_REQUEST[funcao] ?>&cor=<? echo $_REQUEST[cor] ?>');
}
...
?>
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="">
	  ...
	  $sql="SELECT count(*) as total from relacionamento";
	  $db->query($sql);
	  $numlinhas=$db->dados();
      $numlinhas=$numlinhas[0];
	 
	  /////////////////////
	  $sql2="SELECT a.* from relacionamento as a order by nome asc LIMIT $registroinicial,$pagesize";
	  $db->query($sql2);
	  ////////////////////
      ...
      <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#ddddd5">
          <td width="80%" height="24" bgcolor="#ddddd5" class="texto_bold"><div align="left">&nbsp;T&iacute;tulo do relacionamento </div></td>
          <td width="20%" </td>
        </tr>
        <tr>
	  ...
	  ?>
          <tr class="texto" id="cor_fundo<? echo $row['relacionamento'] ?>">
          <td width=80% align="left"><? echo $row[nome]; ?></td>
    
          <td align="center" width='10%'><? echo "<a href=\"relacionamento1.php?op=del&relacionamento=".base64_encode($row['relacionamento'])."\"
	  ...
	  onMouseOver='document.getElementById(\"cor_fundo".$row[relacionamento]."\").style.backgroundColor=\"#ddddd5\";' 
	  onMouseOut='document.getElementById(\"cor_fundo".$row[relacionamento]."\").style.backgroundColor=\"\";'>";?>
          <div align="center"></div></td>
          
          <td align="center" width='10%'><? echo "<a href=\"relacionamento1.php?op=update&relacionamento=".base64_encode($row['relacionamento'])."\">
	  ...
	  onMouseOut='document.getElementById(\"cor_fundo".$row[relacionamento]."\").style.backgroundColor=\"\";'>"; }?>
        ...
        <tr class="texto">
          <td colspan="2">&nbsp;</td>
          <td></td>
          <td align="center"><? echo "<a href=\"relacionamento1.php?op=insert\"><img src='imgs/icons/btn_plus.gif' width='13' height='13' border='0' alt='Novo Registro' >"?></td>
        </tr>
        <tr>
...
$a="<a href=\"relacionamento.php?page=".$first."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";

$b="<a href=\"relacionamento.php?page=".$menos."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";

$c="<a href=\"relacionamento.php?page=".$mais."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";

$d="<a href=\"relacionamento.php?page=".$last."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
$combo="";
...
$g= " Total de relacionamentos cadastrados: $numlinhas - Página: $page_atual de $numpages $lista_combo &nbsp;
...
?>               
       ...
       <p>
          <input name="relacionamento" type="hidden" id="relacionamento" value="<? echo $relacionamento ?>">
