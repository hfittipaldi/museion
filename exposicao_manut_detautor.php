...
document.location=('exposicao_manut_detautor.php?page='+ i+ '&id='+ id );
  ...
  <tr>
	...
	$sql3="SELECT nome,periodo 
 	...
 	$db3->query($sql3);
        ...
        // autor
        $sqla="SELECT count(*) as totalautor 
               FROM exposicao as a INNER JOIN  autor_exposicao as b on 
               (a.exposicao=b.exposicao) INNER JOIN autor as c on (b.autor=c.autor) 
...
<body>
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
      <tr>
         <td valign="top"><form name="form1" method="get" onSubmit='true' action="exposicao_manut_detautor.php">
                 <tr>
                    <table width="100%" height="20"  border="0" cellspan="1" cellpadding="0" cellspacing="0">
                       ...
                       <tr><td colspan="20" width="100%" height="25" class="texto"><div align="left"> &nbsp;(<? echo $_REQUEST[id] ?>)<?echo " - " .$expoano." - <b><em>".$exposel?> </em></b></div></td></tr>
                       <tr bgcolor="#96ADBE">
                       <td colspan="3" bgcolor="#000000" class="texto"><img src="imgs/transp.gif" width="100" height="1"></td>
                       </tr>
		        ...
		        ?>                  
                    ...
                    <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="2" >
                        <tr width="100%" class="texto" id="cor_fundo<? echo $row['expid'] ?>">
                         ...
                         <? if ($arow['autor']!="") 
                             {?> 
                             <td width="100%"><?echo "<b>".$arow['nomeetiqueta']." ";?></td>
                        <?} else {?>
		       ...
		       <? } ?>
                       ...
                       <? 
                          ...
                          $a="<a href=\"exposicao_manut_detautor.php?page=".$first."&id=".$expid."\"><img src='imgs/icons/btn_inicio.gif'  border='0'  alt='Registro Inicial' ></a>";
                          $b="<a href=\"exposicao_manut_detautor.php?page=".$menos."&id=".$expid."\"><img src='imgs/icons/btn_anterior.gif'  border='0' alt='Registro Anterior' ></a>";
                          $c="<a href=\"exposicao_manut_detautor.php?page=".$mais."&id=".$expid."\"><img src='imgs/icons/btn_proximo.gif'  border='0' alt='Proximo Registro' ></a> ";
                          $d="<a href=\"exposicao_manut_detautor.php?page=".$last."&id=".$expid."\"><img src='imgs/icons/btn_ultimo.gif'  border='0' alt='Ultimo Registro' ></a>";
                          $combo="";
